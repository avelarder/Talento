namespace Talento.Core.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Talento.Core.Data.ApplicationDbContext>
    {
        ...
        protected override void Seed(Talento.Core.Data.ApplicationDbContext context)
        {
            ...
            positions.ForEach(r => context.Positions.AddOrUpdate(p => p.PositionId, r));
            context.SaveChanges();
            ...
            var tcsCandidates = new List<Candidate>
            {
               new Candidate{
                   ...
                   CreatedOn = Convert.ToDateTime("2017-03-10T12:30:30"),
               ...
               new Candidate{
                   ...
                   Competencies ="Comma separated competencies",
                   Description = "This is a description",
                   CreatedOn = Convert.ToDateTime("2017-03-20T13:45:30"),
                   CreatedBy = manager.FindByEmail("Pmuser1@example.com")
               },
               new Candidate{
                   CandidateId = 3,
                   ...
                   Competencies="Comma separated competencies",
                   Description = "This is a description",
                   CreatedOn = Convert.ToDateTime("2017-02-09T13:45:30"),
                   CreatedBy = manager.FindByEmail("Pmuser1@example.com")
               },
               new Candidate{
                   CandidateId = 4,
                   ...
                   Competencies="Comma separated competencies",
                   Description = "This is a description",
                   CreatedOn = Convert.ToDateTime("2017-04-11T13:45:30"),
                   CreatedBy = manager.FindByEmail("Pmuser1@example.com")
               },
               new Candidate{
                   CandidateId = 5,
                   ...
                   Competencies="Comma separated competencies",
                   Description = "This is a description",
                   CreatedOn = Convert.ToDateTime("2017-01-16T13:45:30"),
                   CreatedBy = manager.FindByEmail("Pmuser1@example.com"),
               },
               new Candidate{
                   CandidateId = 6,
                   ...
                   Competencies="Comma separated competencies",
                   Description = "This is a description",
                   CreatedOn = Convert.ToDateTime("2017-01-17T13:45:30"),
                   CreatedBy = manager.FindByEmail("Pmuser1@example.com")
               },
               new Candidate{
                   CandidateId = 7,
                   ...
                   Competencies="Comma separated competencies",
                   Description = "This is a description",
                   CreatedOn = Convert.ToDateTime("2017-02-15T13:45:30"),
                   CreatedBy = manager.FindByEmail("Pmuser1@example.com")
               },
               new Candidate{
                   CandidateId = 8,
                   ...
                   Competencies="Comma separated competencies",
                   Description = "This is a description",
                   CreatedOn = Convert.ToDateTime("2017-03-15T13:45:30"),
                   CreatedBy = manager.FindByEmail("Pmuser1@example.com")
               },
               new Candidate{
                   CandidateId = 9,
            ...
            tcsCandidates.ForEach(r => context.Candidates.AddOrUpdate(p => p.CandidateId, r));
            context.SaveChanges();
            ...
            var nontcsCandidates = new List<Candidate>
            {
               new Candidate{
                   ...
                   Competencies="Comma separated competencies",
                   Description = "This is a description",
                   CreatedOn = Convert.ToDateTime("2017-03-01T13:45:30"),
                   CreatedBy = manager.FindByEmail("Pmuser1@example.com"),
                   IsTcsEmployee = false
               },
               new Candidate{
                   ...
                   Competencies="Comma separated competencies",
                   Description = "This is a description",
                   CreatedOn = Convert.ToDateTime("2017-03-04T13:45:30"),
                   CreatedBy = manager.FindByEmail("Pmuser1@example.com"),
                   IsTcsEmployee = false
               },
               new Candidate{
                   ...
                   Competencies="Comma separated competencies",
                   Description = "This is a description",
                   CreatedOn = Convert.ToDateTime("2017-03-06T13:45:30"),
                   CreatedBy = manager.FindByEmail("Pmuser1@example.com"),
                   IsTcsEmployee = false
               },
               new Candidate{
                   ...
                   Competencies="Comma separated competencies",
                   Description = "This is a description",
                   CreatedOn = Convert.ToDateTime("2017-03-09T13:45:30"),
                   CreatedBy = manager.FindByEmail("Pmuser1@example.com"),
                   IsTcsEmployee = false
               },
               new Candidate{
                   ...
                   Competencies="Comma separated competencies",
                   Description = "This is a description",
                   CreatedOn = Convert.ToDateTime("2017-03-12T13:45:30"),
                   CreatedBy = manager.FindByEmail("Pmuser1@example.com"),
                   IsTcsEmployee = false
               },
               new Candidate{
                   ...
                   Competencies="Comma separated competencies",
                   Description = "This is a description",
                   CreatedOn = Convert.ToDateTime("2017-03-17T13:45:30"),
                   CreatedBy = manager.FindByEmail("Pmuser1@example.com"),
                   IsTcsEmployee = false
               },
               new Candidate{
               ...
               new Candidate{
                   ...
                   Competencies="Comma separated competencies",
                   Description = "This is a description",
                   CreatedOn = Convert.ToDateTime("2017-03-22T13:45:30"),
                   CreatedBy = manager.FindByEmail("Pmuser1@example.com"),
                   IsTcsEmployee = false
               },
               new Candidate{
                   ...
                   Competencies="Comma separated competencies",
                   Description = "This is a description",
                   CreatedOn = Convert.ToDateTime("2017-03-27T13:45:30"),
                   CreatedBy = manager.FindByEmail("Pmuser1@example.com"),
                   IsTcsEmployee = false
               }
            };

            nontcsCandidates.ForEach(r => context.Candidates.AddOrUpdate(p => p.CandidateId, r));
            context.SaveChanges();
            ...
            List<Candidate> candidatesPosition1 = context.Candidates.Where(candidate => listId.Contains(candidate.CandidateId)).ToList();

            foreach (Candidate c in candidatesPosition1)
            {
                context.PositionCandidates.Add(new PositionCandidates { Candidate = c, Position = position1, Status = PositionCandidatesStatus.New });
            }
            context.SaveChanges();

            Position position2 = context.Positions.Find(2);
            listId = new List<int> { 6 };
            List<Candidate> candidatesPosition2 = context.Candidates.Where(candidate => listId.Contains(candidate.CandidateId)).ToList();

            foreach (Candidate c in candidatesPosition2)
            {
                context.PositionCandidates.Add(new PositionCandidates { Candidate = c, Position = position2, Status = PositionCandidatesStatus.New });
            }
            context.SaveChanges();

            Position position6 = context.Positions.Find(6);
            listId = new List<int> { 7, 8, 9, 10, 11, 12, 13, 14, 15 };
            List<Candidate> candidatesPosition6 = context.Candidates.Where(candidate => listId.Contains(candidate.CandidateId)).ToList();

            foreach (Candidate c in candidatesPosition6)
            {
                context.PositionCandidates.Add(new PositionCandidates { Candidate = c, Position = position6, Status = PositionCandidatesStatus.New });
            }
            context.SaveChanges();

            Position position5 = context.Positions.Find(5);
            listId = new List<int> { 16, 17, 18, 19, 20 };
            List<Candidate> candidatesPosition5 = context.Candidates.Where(candidate => listId.Contains(candidate.CandidateId)).ToList();

            foreach (Candidate c in candidatesPosition5)
            {
                context.PositionCandidates.Add(new PositionCandidates { Candidate = c, Position = position5, Status = PositionCandidatesStatus.New });
            }
            context.SaveChanges();
            #endregion
